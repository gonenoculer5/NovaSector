...
/obj/machinery/power/energy_accumulator/rad_collector/examine(mob/user)
	...
	. += span_notice("[src]'s display states that it has stored <b>[display_energy(get_stored_joules())]</b>, and is processing <b>[display_power(calculate_energy_output(1))]</b> per second.")
...
/obj/machinery/power/energy_accumulator/rad_collector/proc/rad_act(pulse_strength)
